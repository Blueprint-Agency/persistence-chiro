...
export default async function BlogIndex({ params }: { params: Promise<{ locale: string }> }) {
  ...
  // Blog is English-only, always at the unprefixed `/blog` — colocated under `[locale]`
  // only because Next allows one root layout per route subtree, not because it varies by
  // locale. See proxy.ts.
