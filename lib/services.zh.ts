...
export const servicesZh: Service[] = [
  ...
  },
  {
    ...
    sections: [
      ...
      {
        // Broadened from shockwave-only on 2026-09-12, with the bundle rename in lib/pricing.zh.ts.
        heading: '理疗仪器与运动按摩搭配',
        body: '有些组织单靠双手不够,尤其是已经酸痛几个月的肌腱。评估结果需要时,会在同一次加上合适的理疗仪器:拔罐、热敷、超声波、冲击波或贴扎,看那个部位适合哪一种。',
      },
      {
  ...
  },
  {
    ...
    sections: [
      ...
      {
        // Broadened from shockwave-only on 2026-09-12, with the bundle rename in lib/pricing.zh.ts.
        heading: '理疗仪器与运动按摩的搭配',
        body: '肌腱酸痛几个月不退时,会加上合适的理疗仪器:拔罐、热敷、超声波、冲击波或贴扎,看那一点适合哪一种;肌肉一直绷着放不开时,运动按摩或干针会和力量训练一起用。用不用,看评估结果。',
      },
      {
        heading: '回场时机怎么决定',
