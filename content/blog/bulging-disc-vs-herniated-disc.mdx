...
Even respected clinics blur this in patient facing material. One major clinic's own patient page lists "bulging disc" simply as another name for a herniated disc, without drawing the structural line at all. In everyday conversation, and often in casual clinical use too, "slipped disc" is used as the umbrella term for the whole group, bulge, protrusion or herniation alike, which is exactly how [our own slipped disc page](/conditions/slipped-disc) uses it. None of this means the distinction is meaningless. It means the label alone is not a reliable way to judge how serious a given case is.
